// ================================================================================
// Name        : scatter_v0.cpp  (v0: 8 cofilters / diversified fingerprint moduli)
...
// Run on an ordinary laptop, the execution of scatter takes about 1 and a half minute for ns= 1GB.
//
...
// scatter_v0: diversified fingerprint moduli
// ------------------------------------------
...
int main() {
	...
	// reset hash map
	memset(map, 0b11111111, M_COM + M_DIV_MAX);
	...
	map_output_stream.write((char *)map, M_COM + M_DIV_MAX);
